                ...
                <div class="row">
                    ...
                    <div class="seearch">
                        ...
                        if (isset($_POST['seearch'])) {
                            $s = $_POST['search'];
                            $sql = "select * from users where id='$s' or firstname like '%$s%' or lastname like '%$s%' or email like '%$s%'";
                        } else
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                if ($_SESSION['type'] == 'admin') {
                                                    if ($type != 'admin') {
                                                        ?>
                                                        <td><button class='btn btn-danger'><a href = 'admindeleteuser.php?id=<?php echo $row['id'] ?>'
                                                                    style='color:white;text-decoration:none'>Delete</a></button></td>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <td></td>

            ...
            <div class="row">
                ...
                <div class="seearch">
                    ...
                    if (isset($_POST['seearch'])) {
                        $s = $_POST['search'];
                       $sql = "SELECT * from issuedbooks i,books b, users u where i.bid=b.bid and i.uid=u.id and ( i.bid='$s'or u.id='$s' or b.title like '%$s%' or u.email like '%$s%')";
                    } else
                        $sql = "SELECT * from issuedbooks i,books b, users u where i.bid=b.bid and i.uid=u.id ";
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src=<?php echo "/project/images/$image" ?> width='90px' height='100px'></td>
                                            <td>
                                                <?php echo $user ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button class='btn btn-primary'><a style='color:white;text-decoration:none'
                                                        href='return.php?id=<?php echo $user ?>&bid=<?php echo $id ?>'>Returned</a></button>
                                            </td>
                                            <?php
                                            }else if($return<=$due){
                                                echo "<td>Returned</td>";
